...
## Начало работы - Создание Telegram бота
...
## Настройка - Настройка работы бота
...
* Активируйте бота и добавьте его в канал или группу.
...
* [Опционально] Если вы используете группу Telegram с включённой функцией тем (Topics), заполните поле `ID темы`, чтобы бот отправлял сообщения в нужную тему.
...
>* Скрывать номера телефонов - скрывать номера телефонов в пересылаемых сообщениях для защиты вашей конфиденциальности.
>* Использовать DNS over HTTPS - использование защищенного зашифрованного DNS-сервиса (на основе Cloudflare®).
>* Копирование - Перенаправлять уведомления на другие сервисы, такие как Bark, Lark или PushDeer. Вы можете настроить несколько сервисов для получения копий ваших сообщений.
